/*Company maintains employee information as employee ID, name, designation and salary.
 ...
 If employee does not exist an appropriate message is displayed. If it is, then the system disp
 lays the employee details. Use index sequential file to maintain the data.*/
